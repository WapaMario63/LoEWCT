/****************************************************************************
** Meta object code from reading C++ file 'serverSettingsWidget.h'
**
...
#include "../../LoEWCT/serverSettingsWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'serverSettingsWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_serverSettings_t, stringdata) + ofs \
...
const QMetaObject serverSettings::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_serverSettings.data,
      qt_meta_data_serverSettings,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_serverSettings.stringdata))
